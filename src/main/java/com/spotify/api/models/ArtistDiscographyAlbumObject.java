...
public class ArtistDiscographyAlbumObject {
     ...
     * @param  albumGroup  AlbumGroupEnum value for albumGroup.
     ...
     * @return Returns the AlbumGroupEnum
     */
     ...
     * This field describes the relationship between the artist and the album.
     * @param albumGroup Value for AlbumGroupEnum
     */
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder albumGroup(AlbumGroupEnum albumGroup) {
            this.albumGroup = albumGroup;
            return this;
        }
        ...
        public ArtistDiscographyAlbumObject build() {
            return new ArtistDiscographyAlbumObject(albumType, totalTracks, availableMarkets,
                    externalUrls, href, id, images, name, releaseDate, releaseDatePrecision, type,
                    uri, artists, albumGroup, restrictions);
        }
    }
}
