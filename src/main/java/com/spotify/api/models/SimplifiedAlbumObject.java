...
public class SimplifiedAlbumObject {
    ...
    public static class Builder {
        ...
        public SimplifiedAlbumObject build() {
            return new SimplifiedAlbumObject(albumType, totalTracks, availableMarkets, externalUrls,
                    href, id, images, name, releaseDate, releaseDatePrecision, type, uri, artists,
                    restrictions);
        }
    }
}
