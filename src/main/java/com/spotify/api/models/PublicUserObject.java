...
public class PublicUserObject {
    ...
    protected PublicUserObject(OptionalNullable<String> displayName, ExternalUrlObject externalUrls,
            FollowersObject followers, String href, String id, List<ImageObject> images,
            Type4Enum type, String uri) {
    ...
    public static class Builder {
        ...
        public PublicUserObject build() {
            return new PublicUserObject(displayName, externalUrls, followers, href, id, images,
                    type, uri);
        }
    }
}
